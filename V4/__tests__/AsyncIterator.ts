...
describe('AsyncIterator', () => {
  describe('The AsyncIterator module', () => {
    it('is a function', () => {
      expect(typeof AsyncIterator).toBe('function');
    });
  });

  describe('The AsyncIterator function', () => {
    describe('the result when called with `new`', () => {
      let instance: AsyncIterator<any>;
      beforeEach(() => {
        // We expect an error here since we are instantiating an abstract class
        // @ts-expect-error
        instance = new AsyncIterator();
      });
  ...
  describe('A default AsyncIterator instance', () => {
    ...
    // it('sho', () => {
    //   expect(iterator.eventNames()).toEqual([])
    // });
