...
// TODO: Introduce priority queues for performance. Use cases
// 1 - Trigger the most backed-up clone first; so that we can store less in-memory (though theoretically we may not need to do this here)
// 2 - 
